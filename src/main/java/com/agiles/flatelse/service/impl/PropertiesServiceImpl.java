...
public class PropertiesServiceImpl implements PropertiesService {
    ...
    public Properties saveProperty(PropertiesRequestDto propertiesRequestDto, MultipartFile heroImageFile, List<MultipartFile> additionalImagesFiles) throws Exception {
